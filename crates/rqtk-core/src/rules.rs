...
pub const RULES: &[Rule] = &[
    ...
    Rule { code: "RQ028", summary: "`verifies` annotation names an unknown verification activity" },
    Rule { code: "RQ029", summary: "hand-written status on an activity whose status comes from tests" },
    Rule { code: "RQ030", summary: "`verifies` annotation is not followed by a function" },
